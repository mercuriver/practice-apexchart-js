...
export class CirclePack extends Component {
  ...
  render(animate = true) {
    ...
    enteringCircles
      ...
      .attr("class", (d) => {
        const originalClass =
          canvasZoomEnabled && hierarchyLevel === 3 ? this.getZoomClass(d) : "";
      ...
      .style("stroke", (d) => this.model.getFillColor(d.data.dataGroupName))
      .attr("cx", (d) => d.x)
      .attr("cy", (d) => d.y)
      .transition(
  ...
  handleLegendOnHover = (event: CustomEvent) => {
    ...
    this.parent
      .selectAll("circle.node")
      .transition(
        this.services.transitions.getTransition("legend-hover-circlepack")
      )
      .attr("opacity", (d) => {
  ...
  handleLegendMouseOut = (event: CustomEvent) => {
    this.parent
      .selectAll("circle.node")
      .transition(
        this.services.transitions.getTransition("legend-mouseout-circlepack")
      )
      .attr("opacity", 1);
  };
  ...
  addEventListeners() {
    ...
    this.parent
              ...
              if (child !== null) {
                ...
                if (typeof child.data.value === "number") {
                  ...
                  return {
                    label: child.data.name,
                    labelIcon:
                      canvasZoomEnabled && hierarchyLevel <= 2
                        ? self.getZoomIcon()
                        : null,
                    value: child.value,
                  };
            ...
            items: [
              {
                ...
                labelIcon:
                  zoomable && canvasZoomEnabled && hierarchyLevel <= 2
                    ? self.getZoomIcon()
                    : null,
                value: parentValue,
              },
      ...
      .on("click", function (event, datum) {
        ...
        const zoomedIn =
          Tools.getProperty(self.getOptions(), "canvasZoom", "enabled") &&
