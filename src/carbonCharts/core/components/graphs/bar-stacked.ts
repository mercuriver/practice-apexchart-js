  ...
  render(animate: boolean) {
    ...
    bars
      ...
      .attr("d", (d, i) => {
        ...
        const x0 =
          this.services.cartesianScales.getDomainValue(key, i) - barWidth / 2;
      ...
      .on("mouseover", function (event, datum) {
        ...
        let matchingDataPoint = displayData.find((d) => {
          ...
          const rangeIdentifier =
            self.services.cartesianScales.getRangeIdentifier(d);
          return (
        ...
        if (matchingDataPoint === undefined) {
          ...
          const domainIdentifier =
            self.services.cartesianScales.getDomainIdentifier();
          const rangeIdentifier =
            self.services.cartesianScales.getRangeIdentifier();
          matchingDataPoint = {
