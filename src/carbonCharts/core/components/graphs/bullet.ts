...
export class Bullet extends Component {
    ...
    const renderRangeBoxes = () => {
      ...
      rangeBoxesEnter
        ...
        .attr("d", (d, i) => {
          ...
          if (d.order === 1) {
            x0 =
              this.services.cartesianScales.getDomainValue(d.datum, i) -
              lineHeight / 2;
            x1 = x0 + lineHeight;
            y0 = rangeScaleEnd - 2;
    ...
    const renderBars = () => {
      ...
      barsEnter
        ...
        .attr("d", (d, i) => {
          ...
          const barWidth = 8;
          const x0 =
            this.services.cartesianScales.getDomainValue(d, i) - barWidth / 2;
    ...
    const renderTargetLines = () => {
      ...
      linesEnter
        ...
        .attr("d", (d, i) => {
          ...
          const lineHeight = 24;
          const x0 =
            this.services.cartesianScales.getDomainValue(d, i) - lineHeight / 2;
  ...
  handleLegendOnHover = (event: CustomEvent) => {
    ...
    this.parent
      .selectAll("path.bar")
      .transition(
        this.services.transitions.getTransition("legend-hover-simple-bar")
      )
      .attr("opacity", (d) =>
  ...
  handleLegendMouseOut = (event: CustomEvent) => {
    this.parent
      .selectAll("path.bar")
      .transition(
        this.services.transitions.getTransition("legend-mouseout-simple-bar")
      )
      .attr("opacity", 1);
  };
    ...
    this.parent
      ...
      .on("mouseover", function (event, datum) {
        ...
        const matchingRangeIndex =
          self.getMatchingRangeIndexForDatapoint(datum);
