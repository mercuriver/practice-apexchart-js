...
export class Threshold extends Component {
  ...
  render(animate = false) {
    ...
    const thresholdAxisGroupsMerge =
      thresholdAxisGroupsEnter.merge(thresholdAxisGroups);
    ...
    thresholdAxisGroupsMerge.each(function ({ axisPosition }) {
      const scale =
        self.services.cartesianScales.getScaleByPosition(axisPosition);
      const scaleType =
        self.services.cartesianScales.getScaleTypeByPosition(axisPosition);
  ...
  getFormattedValue(datum) {
    ...
    const scaleType =
      this.services.cartesianScales.getScaleTypeByPosition(axisPosition);
